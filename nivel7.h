...
#define N_JOBS 64                // màxim número de treballs en segon pla
...
static struct info_process jobs_list[N_JOBS + 1]; // N_JOBS + 1 perquè la posició 0 es per guardar dades del procés en foreground